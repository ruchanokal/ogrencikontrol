...
class OgretmenSignInFr : Fragment() {

    private var _binding : FragmentOgretmenSignInBinding? = null
    ...
    private val TAG = "OgretmenSignInFr"

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentOgretmenSignInBinding.inflate(inflater,container,false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.kayitOlText.setOnClickListener {
            ...
            val action = OgretmenSignInFrDirections.actionOgretmenSignInFrToOgretmenSignUpFr()
        ...
        binding.sifremiUnuttumText.setOnClickListener {
            ...
            val action = OgretmenSignInFrDirections.actionOgretmenSignInFrToForgetPasswordFr()
            Navigation.findNavController(it).navigate(action)
    ...
    private fun signIn() {
        ...
        if (email.equals("") && password.equals("")) {
            ...
            reference2 = db.collection("Ogretmen").document(email).addSnapshotListener { value, error ->
    ...
    private fun emailListesiniKontrolEt(email : String, password: String) {
        ...
        //email listesi buraya ait olup olmadığı için kontrol edilmiştir. Adminden kayıt yapanlar
        // burdan giriş yapamaz

        reference2?.remove()

        val query = db.collection("Ogretmen")
            ...
            if (error != null) {
                ...
                if (value != null) {
                    ...
                    if (!value.isEmpty) {
                        ...
                        Log.i(TAG, "öğretmen snapshotListener")
                        ...
                        for (document in documents) {
                            ...
                            Log.i(TAG, "testEmail: " + testEmail)
                            Log.i(TAG, "myEmail: " + email)
