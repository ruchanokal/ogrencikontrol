...
import com.ogrenci.kontrol.databinding.FragmentOgretmenSignUpBinding
import com.ogrenci.kontrol.databinding.LayoutCustomDialogBinding


class OgretmenSignUpFr : Fragment() {

    private var _binding : FragmentOgretmenSignUpBinding? = null
    private val binding get() = _binding!!
    private lateinit var db : FirebaseFirestore
    private val TAG = "OgretmenSignUpFr"
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOgretmenSignUpBinding.inflate(inflater,container,false)
    ...
    private fun databaseCollection() {
        ...
        reference = db.collection("Ogretmen")
    ...
    private fun kontroller() {
        ...
        if (email.equals("")
            ...
            db.collection("Ogretmen").document(email).set(hashMap).addOnSuccessListener {

                Log.i(TAG,"öğretmen database'e eklendi")
                makeDialog()
